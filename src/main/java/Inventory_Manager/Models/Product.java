...
/**
 * FUTURE ENHANCEMENT: I think that making another class to hold associations and other data would be beneficial,
 * this way we can store the amount of required parts as well as the part.
 */

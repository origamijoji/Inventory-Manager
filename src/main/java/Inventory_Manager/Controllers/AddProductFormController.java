...
public class AddProductFormController implements Initializable {
    ...
    public void initialize(URL url, ResourceBundle resourceBundle) {
        ...
        idField.setText(Integer.toString(generateProductID()));
    ...
    /**
     * Set selected part as an associated part
     * @return an event
     */
    ...
    /**
     * Remove selected part as an associated part
     * @return an event
     */
    ...
    /**
     * Create a new product based on the given input
     * @return an event
     */
    ...
    /**
     * Validate the given input, send error if incorrect
     ...
     * @return a unique ID for an Inventory product
     */
